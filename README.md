...
The African Studies curriculum is a complete education in African Studies using online materials.
...
All learners should study the first four sections, in this order:

1. Foundations
2. Historical
3. Political & Economic Systems
4. Society, Culture, and Thought

These sections form a single learning sequence. Start with the first and complete each one before moving to the next. They establish the shared knowledge base needed to understand anything that follows. Do not skip or reorder them.

Within each Core section, work through the subjects from top to bottom. Each subject provides context or tools that later subjects depend on.
...
| Subject | Why study? | Book / Text | Online Resource |
| --- | --- | --- | --- |
| Oral Traditions | It teaches how spoken stories, proverbs, and songs preserve history, morals, and knowledge across generations. | [Open Access Oral Literature in Africa](https://www.openbookpublishers.com/books/10.11647/obp.0025) (Free PDF & eBook) | [OAPEN + Cambridge African Orature](https://www.openbookpublishers.com/books/10.11647/obp.0025) (Full open-access edition) |
| Modern African Literature | You explore how novels, poems, and stories express African experiences, identities, and responses to change. | — | [Yale African literature lectures](https://oyc.yale.edu/african-american-studies/afam-162) (Open Yale Courses) |
...
| Subject | Why study? | Book / Text | Online Resource |
| --- | --- | --- | --- |
| Pan-Africanism | It shows how ideas of unity and shared identity connect people of African descent worldwide to fight for rights and pride. | — | [Black Past Pan-Africanism archive](https://www.panafricandata.org/en/) (Essays & timelines) |
...
| Subject | Why study? | Book / Text | Online Resource |
| --- | --- | --- | --- |
| Environment & Climate | You learn how climate change and conservation affect Africa's land, animals, and people's ways of living now and in the future. | [OpenBookPublishers – Conservation Biology](https://www.openbookpublishers.com/books/10.11647/obp.0177) | [Coursera – Climate Adaptation in Africa](https://www.coursera.org/learn/climate-adaptation) |
| Public Health | It helps you see the causes of diseases and how health systems work to protect communities across the continent. | — | [WHO Africa open reports](https://www.afro.who.int/publications/atlas-african-health-statistics-2022-health-situation-analysis-who-african-region-1) (Annual health statistics & reports) |
| Population & Migration | You understand how growing populations and movements of people shape economies, cities, and societies in Africa today. | — | [World Bank Africa data portal](https://data.worldbank.org/country/africa) (Population & migration datasets) |

## Congratulations

After completing the requirements of the curriculum above,
you will have completed the equivalent of a full bachelor's degree in African Studies.
Congratulations!
